...
const ClueList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<p class="${"svelte-1ezmsjk"}">${escape(direction)}</p>
<div class="${"list svelte-1ezmsjk"}"><ul class="${"svelte-1ezmsjk"}">${each(clues, clue => `${validate_component(Clue, "Clue").$$render(
		$$result,
		{
			clue: clue.clue,
			number: clue.number,
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword " + escape(themeClass) + " svelte-7uktid"}">${slots.toolbar
			? slots.toolbar({ onClear, onReveal })
			: `
		${validate_component(Toolbar, "Toolbar").$$render($$result, { actions }, {}, {})}
	`}

	<div class="${["play svelte-7uktid", desktop ? "desktop" : ""].join(" ").trim()}">${validate_component(Clues, "Clues").$$render(
				$$result,
				{
					clues,
					cellIndexMap,
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<article class="${"svelte-hz1mll"}"><div class="${"intro svelte-hz1mll"}"><h1 class="${"svelte-hz1mll"}">Svelte Crossword</h1>
    <p class="${"svelte-hz1mll"}">A crossword component for
      <a href="${"https://svelte.dev"}">Svelte</a>. Read the docs on
      <a href="${"https://github.com/russellgoldenberg/svelte-crossword#svelte-crossword"}">Github</a>.
    </p></div>

  <section id="${"default"}" class="${"svelte-hz1mll"}"><div class="${"info svelte-hz1mll"}"><h2 class="${"svelte-hz1mll"}">Default</h2>
			<p class="${"svelte-hz1mll"}">A
				<a href="${"https://www.nytimes.com/crosswords/game/daily/2020/10/21"}">NYT
					daily</a>
				puzzle with all default settings.
			</p></div>
  ...
  <section id="${"mini"}" style="${"max-width: 480px;"}" class="${"svelte-hz1mll"}"><div class="${"info svelte-hz1mll"}"><h2 class="${"svelte-hz1mll"}">Mobile</h2>
			<p class="${"svelte-hz1mll"}">A
				<a href="${"https://www.nytimes.com/crosswords/game/mini/2020/10/21"}">NYT mini</a>
				puzzle with all default settings and forced mobile view.
			</p></div>
  ...
  <section id="${"themes"}" class="${"svelte-hz1mll"}"><div class="${"info svelte-hz1mll"}"><h2 class="${"svelte-hz1mll"}">Themes</h2>
			<p class="${"svelte-hz1mll"}">A library of preset style themes to choose from.</p>
  ...
  <section id="${"simple-customization"}" class="${["svelte-hz1mll", revealedUSA ? "is-revealed" : ""].join(" ").trim()}"><div class="${"info svelte-hz1mll"}"><h2 class="${"svelte-hz1mll"}">Simple Customization</h2>
			<p class="${"svelte-hz1mll"}">Custom class name on cells.</p></div>
  ...
  <section id="${"advanced-customization"}" class="${"svelte-hz1mll"}"><div class="${"info svelte-hz1mll"}"><h2 class="${"svelte-hz1mll"}">Advanced Customization</h2>
			<p class="${"svelte-hz1mll"}">TBD.</p></div>
