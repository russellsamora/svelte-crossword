...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(button, "class", button_class_value = "clue " + /*custom*/ ctx[2] + " svelte-18jb96c");
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$7, 39, 4, 1048);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*focusedClueNumbers, clues, focusedDirection, isDisableHighlight, onClueFocus*/ 91) {
    ...
    function create_if_block$4(ctx) {
    	...
    	cluebar = new ClueBar({
    			props: { currentClue: /*currentClue*/ ctx[5] },
    			$$inline: true
    		});

    	cluebar.$on("nextClue", /*onNextClue*/ ctx[7]);
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$7, 35, 4, 921);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*currentClue*/ 32) cluebar_changes.currentClue = /*currentClue*/ ctx[5];
    ...
    // (41:6) {#each ['across', 'down'] as direction}
    function create_each_block$4(ctx) {
    	let cluelist;
    	let current;

    	function func(...args) {
    		return /*func*/ ctx[11](/*direction*/ ctx[12], ...args);
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:6) {#each ['across', 'down'] as direction}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(section, file$7, 33, 0, 863);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	function onClueFocus({ direction, id }) {
    		...
    		$$invalidate(8, focusedCellIndex = cellIndexMap[id] || 0);
    	}
    	...
    	$$self.$$set = $$props => {
    		if ("clues" in $$props) $$invalidate(1, clues = $$props.clues);
    		if ("cellIndexMap" in $$props) $$invalidate(9, cellIndexMap = $$props.cellIndexMap);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentClue" in $$props) $$invalidate(5, currentClue = $$props.currentClue);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*focusedCell*/ 1024) {
    			 $$invalidate(4, focusedClueNumbers = focusedCell.clueNumbers || {});
    		}

    		if ($$self.$$.dirty & /*clues, focusedDirection, focusedClueNumbers*/ 19) {
    			 $$invalidate(5, currentClue = clues.find(c => c.direction === focusedDirection && c.number === focusedClueNumbers[focusedDirection]));
    		}
    	};
    ...
    class Clues extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*cellIndexMap*/ ctx[9] === undefined && !("cellIndexMap" in props)) {
    		...
    		if (/*focusedCellIndex*/ ctx[8] === undefined && !("focusedCellIndex" in props)) {
    			console.warn("<Clues> was created without expected prop 'focusedCellIndex'");
    		}

    		if (/*focusedCell*/ ctx[10] === undefined && !("focusedCell" in props)) {
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*isDisableHighlight*/ 32768) clues_1_changes.isDisableHighlight = /*isDisableHighlight*/ ctx[15];
    ...
    // (144:4) {#if isComplete && !isRevealing && showCompleteMessage}
    function create_if_block_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(144:4) {#if isComplete && !isRevealing && showCompleteMessage}",
    		ctx
    	});
    ...
    // (145:6) <CompletedMessage showConfetti="{showConfetti}">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(145:6) <CompletedMessage showConfetti=\\\"{showConfetti}\\\">",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(option0, file$b, 54, 8, 1484);
