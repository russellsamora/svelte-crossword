...
var app = (function () {
    ...
    // (85:6) <div         class="toolbar"         slot="toolbar"         let:onClear         let:onReveal         style="background: yellow; padding: 2em;">
    function create_toolbar_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(button0, file$b, 90, 8, 2511);
    			add_location(button1, file$b, 91, 8, 2570);
    			attr_dev(div, "class", "toolbar");
    			attr_dev(div, "slot", "toolbar");
    			set_style(div, "background", "yellow");
    			set_style(div, "padding", "2em");
    			add_location(div, file$b, 84, 6, 2359);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(85:6) <div         class=\\\"toolbar\\\"         slot=\\\"toolbar\\\"         let:onClear         let:onReveal         style=\\\"background: yellow; padding: 2em;\\\">",
    		ctx
    	});
    ...
    function create_complete_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h3, file$b, 94, 8, 2671);
    			...
    			add_location(img, file$b, 95, 8, 2703);
    			attr_dev(div, "slot", "complete");
    			add_location(div, file$b, 93, 6, 2641);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    // (84:4) <Crossword data="{dataNYTDaily}">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(84:4) <Crossword data=\\\"{dataNYTDaily}\\\">",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(h22, file$b, 53, 6, 1437);
    			attr_dev(p3, "class", "svelte-1v4ih91");
    			add_location(p3, file$b, 54, 6, 1459);
    			option0.__value = "classic";
    			option0.value = option0.__value;
    			add_location(option0, file$b, 56, 8, 1559);
    			option1.__value = "dark";
    			option1.value = option1.__value;
    			add_location(option1, file$b, 57, 8, 1608);
    			option2.__value = "citrus";
    			option2.value = option2.__value;
    			add_location(option2, file$b, 59, 8, 1707);
    			if (/*theme*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file$b, 55, 6, 1521);
    			attr_dev(div3, "class", "info svelte-1v4ih91");
    			add_location(div3, file$b, 52, 4, 1412);
    			add_location(div4, file$b, 62, 4, 1777);
    			...
    			add_location(h23, file$b, 69, 6, 1963);
    			attr_dev(p4, "class", "svelte-1v4ih91");
    			add_location(p4, file$b, 70, 6, 1999);
    			attr_dev(div5, "class", "info svelte-1v4ih91");
    			add_location(div5, file$b, 68, 4, 1938);
