...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<article class="${"svelte-1uvk5z8"}"><div class="${"intro svelte-1uvk5z8"}"><h1 class="${"svelte-1uvk5z8"}">svelte-crossword</h1>
    <p class="${"svelte-1uvk5z8"}">A crossword component for
      <a href="${"https://svelte.dev"}">Svelte</a>. Read the docs on
  ...
  <section id="${"default"}" class="${"svelte-1uvk5z8"}"><div class="${"info svelte-1uvk5z8"}"><h2 class="${"svelte-1uvk5z8"}">Default</h2>
      <p class="${"svelte-1uvk5z8"}">A
        <a href="${"https://www.nytimes.com/crosswords/game/daily/2020/10/21"}">NYT
          daily</a>
        puzzle with all default settings.
      </p></div>
  ...
  <section id="${"mini"}" style="${"max-width: 500px;"}" class="${"svelte-1uvk5z8"}"><div class="${"info svelte-1uvk5z8"}"><h2 class="${"svelte-1uvk5z8"}">Mobile</h2>
      <p class="${"svelte-1uvk5z8"}">A
        <a href="${"https://www.nytimes.com/crosswords/game/mini/2020/10/21"}">NYT
          mini</a>
        puzzle with all default settings and forced mobile view.
  ...
  <section id="${"themes"}" class="${escape(null_to_empty(theme)) + " svelte-1uvk5z8"}" style="${"max-width: 760px;"}"><div class="${"info svelte-1uvk5z8"}"><h2 class="${"svelte-1uvk5z8"}">Themes</h2>
      <p class="${"svelte-1uvk5z8"}">A library of preset style themes to choose from.</p>
  ...
  <section id="${"simple-customization"}" class="${["svelte-1uvk5z8", revealedUSA ? "is-revealed" : ""].join(" ").trim()}"><div class="${"info svelte-1uvk5z8"}"><h2 class="${"svelte-1uvk5z8"}">Simple Customization</h2>
      <p class="${"svelte-1uvk5z8"}">A few customizations: custom class names on clues and cells,
        <code class="${"svelte-1uvk5z8"}">revealed</code>
        binding (apply custom style), and
        <code class="${"svelte-1uvk5z8"}">disableHighlight</code>
        parameter.
      </p></div>
  ...
  <section id="${"slots"}" class="${"svelte-1uvk5z8"}"><div class="${"info svelte-1uvk5z8"}"><h2 class="${"svelte-1uvk5z8"}">Slots</h2>
      <p class="${"svelte-1uvk5z8"}">Custom slots for the toolbar and completion message.</p></div>
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataNYTDaily }, {}, {
			toolbar: ({ onClear, onReveal }) => `<div class="${"toolbar"}" slot="${"toolbar"}" style="${"background: tan; padding: 1em; margin: 1em 0;"}"><button style="${"font-size: 1.5em; background-color: red;"}" class="${"svelte-1uvk5z8"}">clear puzzle</button>
        <button style="${"font-size: 1.5em; background-color: red;"}" class="${"svelte-1uvk5z8"}">show answers</button></div>`,
