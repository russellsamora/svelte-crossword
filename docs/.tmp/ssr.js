...
const css$2 = {
	code: "g.svelte-nsveje.svelte-nsveje{cursor:pointer;user-select:none}g.svelte-nsveje.svelte-nsveje:focus{outline:none}g.is-secondarily-focused.svelte-nsveje rect.svelte-nsveje{fill:var(--secondary-highlight-color)}g.is-focused.svelte-nsveje rect.svelte-nsveje{fill:var(--primary-highlight-color)}rect.svelte-nsveje.svelte-nsveje{transition:fill 0.1s ease-out}text.svelte-nsveje.svelte-nsveje{pointer-events:none;line-height:1;font-family:var(--font);fill:var(--main-color)}.value.svelte-nsveje.svelte-nsveje{font-size:0.7em;font-weight:700}.number.svelte-nsveje.svelte-nsveje{font-size:0.3em;font-weight:400;fill:var(--main-color);opacity:0.5}rect.svelte-nsveje.svelte-nsveje{fill:var(--bg-color);stroke:var(--main-color);stroke-width:0.01em}",
...
const Puzzle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${[
		"puzzle svelte-15vltml",
		(stacked ? "stacked" : "") + " " + (isLoaded ? "is-loaded" : "")
	].join(" ").trim()}"><svg viewBox="${"0 0 " + escape(w) + " " + escape(h)}" class="${"svelte-15vltml"}">${each(cells, ({ x, y, value, index, number, custom }) => `${validate_component(Cell, "Cell").$$render(
		$$result,
		{
			x,
			y,
...
&#39;${keyboardVisible
	? `
  <div class="${"keyboard svelte-15vltml"}">${validate_component(Keyboard, "Keyboard").$$render($$result, {}, {}, {})}</div>`
	: ``}`;
});
...
const Clue = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<li${add_attribute("this", element, 1)}><button class="${[
		"clue " + escape(custom) + " svelte-1bqaeqz",
...
const ClueList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<p class="${"svelte-1eoups6"}">${escape(direction)}</p>
<div class="${"list svelte-1eoups6"}"><ul class="${"svelte-1eoups6"}">${each(clues, clue => `${validate_component(Clue, "Clue").$$render(
		$$result,
		{
			clue: clue.clue,
			number: clue.number,
...
const ClueBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"bar " + escape(custom) + " svelte-1rm1yc6"}"><button class="${"svelte-1rm1yc6"}"><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" class="${"feather feather-chevron-left"}"><polyline points="${"15 18 9 12 15 6"}"></polyline></svg></button>
  <p class="${"svelte-1rm1yc6"}">${escape(clue)}</p>
  <button class="${"svelte-1rm1yc6"}"><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" class="${"feather feather-chevron-right"}"><polyline points="${"9 18 15 12 9 6"}"></polyline></svg></button>
</div>`;
});
...
const css$9 = {
	code: ".completed.svelte-1u461hl{position:absolute;top:min(50%, 15em);left:50%;background:white;transform:translate(-50%, -50%);border-radius:4px;z-index:100;box-shadow:0 4px 8px 4px rgba(0, 0, 0, 0.2)}.curtain.svelte-1u461hl{position:absolute;top:0;right:0;bottom:0;left:0;background:#fff;opacity:0.9;cursor:pointer;z-index:1}h3.svelte-1u461hl{margin:0;margin-bottom:0.5em}button.svelte-1u461hl{cursor:pointer;margin-left:1em;font-size:1em;font-family:var(--font);background-color:var(--accent-color);border-radius:4px;color:var(--main-color);padding:0.75em;border:none;font-weight:400;transition:background-color 150ms}button.svelte-1u461hl:hover{background-color:var(--secondary-highlight-color)}.content.svelte-1u461hl{position:relative;display:flex;flex-direction:column;align-items:center;padding:2em}.message.svelte-1u461hl{margin-bottom:1em}.confetti.svelte-1u461hl{position:absolute;top:30%;left:50%;transform:translate(-50%, -50%)}",
	map: "{\"version\":3,\"file\":\"CompletedMessage.svelte\",\"sources\":[\"CompletedMessage.svelte\"],\"sourcesContent\":[\"<script>\\n  import { fade } from \\\"svelte/transition\\\";\\n  import Confetti from \\\"./Confetti.svelte\\\";\\n\\n  export let showConfetti = true;\\n\\n  let isOpen = true;\\n</script>\\n\\n{#if isOpen}\\n  <div class=\\\"completed\\\" transition:fade=\\\"{{ y: 20 }}\\\">\\n    <div class=\\\"content\\\">\\n      <div class=\\\"message\\\">\\n        <slot name=\\\"message\\\">\\n          <h3>You solved it!</h3>\\n        </slot>\\n      </div>\\n\\n      <button on:click=\\\"{() => (isOpen = false)}\\\">View puzzle</button>\\n    </div>\\n\\n    {#if showConfetti}\\n      <div class=\\\"confetti\\\">\\n        <Confetti />\\n      </div>\\n    {/if}\\n  </div>\\n  <div\\n    class=\\\"curtain\\\"\\n    transition:fade=\\\"{{ duration: 250 }}\\\"\\n    on:click=\\\"{() => (isOpen = false)}\\\"></div>\\n{/if}\\n\\n<style>\\n  .completed {\\n    position: absolute;\\n    top: min(50%, 15em);\\n    left: 50%;\\n    background: white;\\n    transform: translate(-50%, -50%);\\n    border-radius: 4px;\\n    z-index: 100;\\n    box-shadow: 0 4px 8px 4px rgba(0, 0, 0, 0.2);\\n  }\\n\\n  .curtain {\\n    position: absolute;\\n    top: 0;\\n    right: 0;\\n    bottom: 0;\\n    left: 0;\\n    background: #fff;\\n    opacity: 0.9;\\n    cursor: pointer;\\n    z-index: 1;\\n  }\\n\\n  h3 {\\n    margin: 0;\\n    margin-bottom: 0.5em;\\n  }\\n\\n  button {\\n    cursor: pointer;\\n    margin-left: 1em;\\n    font-size: 1em;\\n    font-family: var(--font);\\n    background-color: var(--accent-color);\\n    border-radius: 4px;\\n    color: var(--main-color);\\n    padding: 0.75em;\\n    border: none;\\n    font-weight: 400;\\n    transition: background-color 150ms;\\n  }\\n\\n  button:hover {\\n    background-color: var(--secondary-highlight-color);\\n  }\\n\\n  .content {\\n    position: relative;\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    padding: 2em;\\n  }\\n\\n  .message {\\n    margin-bottom: 1em;\\n  }\\n\\n  .confetti {\\n    position: absolute;\\n    top: 30%;\\n    left: 50%;\\n    transform: translate(-50%, -50%);\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAkCE,UAAU,eAAC,CAAC,AACV,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,GAAG,CAAC,CAAC,IAAI,CAAC,CACnB,IAAI,CAAE,GAAG,CACT,UAAU,CAAE,KAAK,CACjB,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,CAChC,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AAC9C,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,OAAO,CACf,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,EAAE,eAAC,CAAC,AACF,MAAM,CAAE,CAAC,CACT,aAAa,CAAE,KAAK,AACtB,CAAC,AAED,MAAM,eAAC,CAAC,AACN,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,GAAG,CACd,WAAW,CAAE,IAAI,MAAM,CAAC,CACxB,gBAAgB,CAAE,IAAI,cAAc,CAAC,CACrC,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,MAAM,CACf,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,GAAG,CAChB,UAAU,CAAE,gBAAgB,CAAC,KAAK,AACpC,CAAC,AAED,qBAAM,MAAM,AAAC,CAAC,AACZ,gBAAgB,CAAE,IAAI,2BAA2B,CAAC,AACpD,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,QAAQ,eAAC,CAAC,AACR,aAAa,CAAE,GAAG,AACpB,CAAC,AAED,SAAS,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,SAAS,CAAE,UAAU,IAAI,CAAC,CAAC,IAAI,CAAC,AAClC,CAAC\"}"
};
...
const CompletedMessage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${ `<div class="${"completed svelte-1u461hl"}"><div class="${"content svelte-1u461hl"}"><div class="${"message svelte-1u461hl"}">${slots.message
		? slots.message({})
		: `
          <h3 class="${"svelte-1u461hl"}">You solved it!</h3>
        `}</div>

      <button class="${"svelte-1u461hl"}">View puzzle</button></div>

    ${showConfetti
		? `<div class="${"confetti svelte-1u461hl"}">${validate_component(Confetti, "Confetti").$$render($$result, {}, {}, {})}</div>`
		: ``}</div>
  <div class="${"curtain svelte-1u461hl"}"></div>`
	}`;
});
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword svelte-7zvqow"}"${add_attribute("style", inlineStyles, 0)}>${slots.toolbar
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <section id="${"themes"}" style="${"background: " + escape( "transparent")}" class="${"svelte-1v4ih91"}"><div class="${"info svelte-1v4ih91"}"><h2 class="${"svelte-1v4ih91"}">Themes</h2>
