    ...
    function create_toolbar_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$b, 91, 8, 2449);
    			add_location(button1, file$b, 92, 8, 2508);
    			attr_dev(div, "class", "toolbar");
    			attr_dev(div, "slot", "toolbar");
    			set_style(div, "background", "yellow");
    			set_style(div, "padding", "2em");
    			add_location(div, file$b, 85, 6, 2297);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button0);
    ...
    function create_complete_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			img = element("img");
    			add_location(h3, file$b, 95, 8, 2609);
    			...
    			add_location(img, file$b, 96, 8, 2641);
    			attr_dev(div, "slot", "complete");
    			add_location(div, file$b, 94, 6, 2579);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h22, file$b, 51, 6, 1340);
    			attr_dev(p3, "class", "svelte-powwth");
    			add_location(p3, file$b, 52, 6, 1362);
    			option0.__value = "classic";
    			option0.value = option0.__value;
    			add_location(option0, file$b, 54, 8, 1462);
    			option1.__value = "dark";
    			option1.value = option1.__value;
    			add_location(option1, file$b, 55, 8, 1511);
    			option2.__value = "amelia";
    			option2.value = option2.__value;
    			add_location(option2, file$b, 56, 8, 1554);
    			option3.__value = "citrus";
    			option3.value = option3.__value;
    			add_location(option3, file$b, 57, 8, 1601);
    			if (/*theme*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file$b, 53, 6, 1424);
    			attr_dev(div3, "class", "info svelte-powwth");
    			add_location(div3, file$b, 50, 4, 1315);
    			add_location(div4, file$b, 60, 4, 1671);
    			attr_dev(section2, "id", "themes");
    			attr_dev(section2, "class", "svelte-powwth");
    			add_location(section2, file$b, 49, 2, 1289);
    			attr_dev(h23, "class", "svelte-powwth");
    			add_location(h23, file$b, 70, 6, 1911);
    			attr_dev(p4, "class", "svelte-powwth");
    			add_location(p4, file$b, 71, 6, 1947);
    			attr_dev(div5, "class", "info svelte-powwth");
    			add_location(div5, file$b, 69, 4, 1886);
