...
const Toolbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.hideReset === void 0 && $$bindings.hideReset && hideReset !== void 0) $$bindings.hideReset(hideReset);
	if ($$props.hideReveal === void 0 && $$bindings.hideReveal && hideReveal !== void 0) $$bindings.hideReveal(hideReveal);
	$$result.css.add(css);

	return `<div class="${"toolbar svelte-1vlfdiw"}">${!hideReset
	? `<button class="${"svelte-1vlfdiw"}">Reset</button>`
	: ``}
  ${!hideReveal
	? `<button class="${"svelte-1vlfdiw"}">Reveal</button>`
	: ``}
</div>`;
});
...
const css$1 = {
	code: "g.svelte-1623cyf.svelte-1623cyf{cursor:pointer;user-select:none}g.svelte-1623cyf.svelte-1623cyf:focus{outline:none}g.is-secondarily-focused.svelte-1623cyf rect.svelte-1623cyf{fill:var(--cell-highlight-color, #ffec99)}g.is-focused.svelte-1623cyf rect.svelte-1623cyf{fill:var(--cell-secondary-color, #ffcc00)}rect.svelte-1623cyf.svelte-1623cyf{transition:fill 0.1s ease-out}text.svelte-1623cyf.svelte-1623cyf{pointer-events:none;line-height:1;fill:var(--cell-text-color, #1a1a1a)}.value.svelte-1623cyf.svelte-1623cyf{font-size:var(--cell-font-size, 0.7em);font-weight:var(--cell-font-weight, 700)}.number.svelte-1623cyf.svelte-1623cyf{font-size:var(--number-font-size, 0.3em);font-weight:var(--number-font-weight, 300);fill:var(--number-color, #8a8a8a)}rect.svelte-1623cyf.svelte-1623cyf{fill:var(--cell-bg-color, #fff);stroke:var(--cell-border-color, #1a1a1a);stroke-width:var(--cell-border-width, 0.01)}",
...
<g class="${[
		"cell " + escape(custom) + " svelte-1623cyf",
		(isFocused ? "is-focused" : "") + " " + (isSecondarilyFocused ? "is-secondarily-focused" : "")
	].join(" ").trim()}"${add_attribute("transform", `translate(${x}, ${y})`, 0)} id="${"cell-" + escape(x) + "-" + escape(y)}" tabIndex="${"0"}"${add_attribute("this", element, 1)}><rect width="${"1"}" height="${"1"}" class="${"svelte-1623cyf"}"></rect>${value
	? `<text class="${"value svelte-1623cyf"}" x="${"0.5"}" y="${"0.9"}" alignment-baseline="${"baseline"}" text-anchor="${"middle"}">${escape(value)}</text>`
	: ``}<text class="${"number svelte-1623cyf"}" x="${"0.1"}" y="${"0.1"}" alignment-baseline="${"hanging"}" text-anchor="${"start"}">${escape(number)}</text></g>`;
});
...
const Clue = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<li${add_attribute("this", element, 1)}><button class="${[
		"clue svelte-1j61t0g",
		(isNumberFocused ? "is-number-focused" : "") + " " + (isDirectionFocused ? "is-direction-focused" : "")
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validate_component(Toolbar, "Toolbar").$$render($$result, { hideReset, hideReveal }, {}, {})}

<article class="${"crossword " + escape(themeClass) + " svelte-b1thkj"}">${validated
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<article class="${"svelte-1y9hplj"}"><section class="${"nyt svelte-1y9hplj"}"><h1 class="${"svelte-1y9hplj"}">NYT Mini</h1>
		<p class="${"svelte-1y9hplj"}">Default options.</p>
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataNYT }, {}, {})}</section>

  <section class="${"amelia svelte-1y9hplj"}"><h1 class="${"svelte-1y9hplj"}">Oreo</h1>
		<p class="${"svelte-1y9hplj"}">Custom themes</p>
		<select><option value="${"Classic"}">Classic</option><option value="${"Dark"}">Dark</option><option value="${"Amelia"}">Amelia</option></select>
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataOreo, theme: "oreo" }, {}, {})}</section>

  <section class="${["usa svelte-1y9hplj", revealedUSA ? "is-revealed" : ""].join(" ").trim()}"><h1 class="${"svelte-1y9hplj"}">People in USA Today puzzles</h1>
		<p class="${"svelte-1y9hplj"}">Custom class name on cells.</p>
