...
<g class="${[
	...
	? `<text class="${"value svelte-1623cyf"}" x="${"0.5"}" y="${"0.9"}" dominant-baseline="${"auto"}" text-anchor="${"middle"}">${escape(value)}</text>`
	: ``}<text class="${"number svelte-1623cyf"}" x="${"0.1"}" y="${"0.1"}" dominant-baseline="${"hanging"}" text-anchor="${"start"}">${escape(number)}</text></g>`;
});
...
<article class="${"crossword " + escape(themeClass) + " svelte-gxh9m5"}">${validated
