    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-1d4ytnk");
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "toolbar svelte-1d4ytnk");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(svg, "class", "svelte-1q7m2j2");
    			attr(section, "class", "puzzle svelte-1q7m2j2");
    			toggle_class(section, "stacked", /*stacked*/ ctx[4]);
    			attr(div, "class", "keyboard svelte-1q7m2j2");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			t1 = text(".\n    ");
    			t2 = text(/*clue*/ ctx[1]);
    			attr(button, "class", "clue svelte-1i661i1");
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(p, "class", "svelte-1k6v3oi");
    			attr(ul, "class", "svelte-1k6v3oi");
    			attr(div, "class", "list svelte-1k6v3oi");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button0, "class", "svelte-1k30qnz");
    			attr(p, "class", "svelte-1k30qnz");
    			attr(button1, "class", "svelte-1k30qnz");
    			attr(div, "class", "bar svelte-1k30qnz");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, button0);
    ...
    function create_if_block$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div, "class", "clues--stacked svelte-8zo0qz");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			section = element("section");
    			if_block.c();
    			attr(section, "class", "clues svelte-8zo0qz");
    ...
    function create_if_block$5(ctx) {
    	...
    	return {
    		c() {
    			...
    			t2 = space();
    			if (if_block) if_block.c();
    			attr(div, "class", "play svelte-1ein5he");
    			toggle_class(div, "stacked", /*stacked*/ ctx[16]);
    			attr(article, "class", article_class_value = "crossword " + /*themeClass*/ ctx[14] + " svelte-1ein5he");
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0.innerHTML = `<h1 class="svelte-powwth">Svelte Crossword</h1> 
    <p class="svelte-powwth">A crossword component for
      ...
      <a href="https://github.com/russellgoldenberg/svelte-crossword#svelte-crossword">Github</a>.</p>`;
    			...
    			div1.innerHTML = `<h2 class="svelte-powwth">Default</h2> 
      <p class="svelte-powwth">A
        ...
        puzzle with all default settings.</p>`;
    			...
    			div2.innerHTML = `<h2 class="svelte-powwth">Mobile</h2> 
      <p class="svelte-powwth">A
        ...
        puzzle with all default settings and forced mobile view.</p>`;
    			...
    			div5.innerHTML = `<h2 class="svelte-powwth">Simple Customization</h2> 
      <p class="svelte-powwth">Custom class name on cells.</p>`;
    			...
    			div6.innerHTML = `<h2 class="svelte-powwth">Advanced Customization</h2> 
      <p class="svelte-powwth">TBD.</p>`;

    			t40 = space();
    			create_component(crossword4.$$.fragment);
    			attr(div0, "class", "intro svelte-powwth");
    			attr(div1, "class", "info svelte-powwth");
    			attr(section0, "id", "default");
    			attr(section0, "class", "svelte-powwth");
    			attr(div2, "class", "info svelte-powwth");
    			attr(section1, "id", "mini");
    			set_style(section1, "max-width", "480px");
    			attr(section1, "class", "svelte-powwth");
    			attr(h22, "class", "svelte-powwth");
    			attr(p3, "class", "svelte-powwth");
    			...
    			attr(div3, "class", "info svelte-powwth");
    			attr(section2, "id", "themes");
    			attr(section2, "class", "svelte-powwth");
    			attr(div5, "class", "info svelte-powwth");
    			attr(section3, "id", "simple-customization");
    			attr(section3, "class", "svelte-powwth");
    			toggle_class(section3, "is-revealed", /*revealedUSA*/ ctx[0]);
    			attr(div6, "class", "info svelte-powwth");
    			attr(section4, "id", "advanced-customization");
    			attr(section4, "class", "svelte-powwth");
    			attr(article, "class", "svelte-powwth");
    		},
    		m(target, anchor) {
    			insert(target, article, anchor);
    			append(article, div0);
