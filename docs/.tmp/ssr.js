...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword " + escape(themeClass) + " svelte-1cndb7v"}">${slots.toolbar
			? slots.toolbar({ onReset, onReveal })
			: `
		${validate_component(Toolbar, "Toolbar").$$render($$result, { actions }, {}, {})}
	`}

	<div class="${"play svelte-1cndb7v"}">${validate_component(Clues, "Clues").$$render(
				$$result,
				{
					clues,
					cellIndexMap,
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<article class="${"svelte-1o1l0pp"}"><div class="${"intro svelte-1o1l0pp"}"><h1 class="${"svelte-1o1l0pp"}">Svelte Crossword</h1>
		<p class="${"svelte-1o1l0pp"}">A crossword component for <a href="${"https://svelte.dev"}">Svelte</a>. Read the docs on <a href="${"https://github.com/russellgoldenberg/svelte-crossword#svelte-crossword"}">Github</a>.</p></div>
  <section class="${"nyt-mini svelte-1o1l0pp"}"><p class="${"example svelte-1o1l0pp"}">Example</p>
    <h1 class="${"svelte-1o1l0pp"}">Default</h1>
    <p class="${"svelte-1o1l0pp"}">An <a href="${"https://www.nytimes.com/crosswords/game/mini/2020/10/21"}">NYT mini</a> puzzle with all default settings.</p>
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataNYTMini }, {}, {})}</section>

	<section class="${"nyt-daily svelte-1o1l0pp"}"><p class="${"example svelte-1o1l0pp"}">Example</p>
    <h1 class="${"svelte-1o1l0pp"}">Default</h1>
    <p class="${"svelte-1o1l0pp"}">An <a href="${"https://www.nytimes.com/crosswords/game/daily/2020/10/21"}">NYT daily</a> puzzle with all default settings.</p>
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataNYTDaily }, {}, {})}</section>

  <section class="${"amelia svelte-1o1l0pp"}"><p class="${"example svelte-1o1l0pp"}">Example</p>
    <h1 class="${"svelte-1o1l0pp"}">Themes</h1>
    <p class="${"svelte-1o1l0pp"}">A library of preset style themes to choose from.</p>
  ...
  <section class="${["usa svelte-1o1l0pp", revealedUSA ? "is-revealed" : ""].join(" ").trim()}"><p class="${"example svelte-1o1l0pp"}">Example</p>
    <h1 class="${"svelte-1o1l0pp"}">Simple Customization</h1>
    <p class="${"svelte-1o1l0pp"}">Custom class name on cells.</p>
  ...
  <section class="${"svelte-1o1l0pp"}"><p class="${"example svelte-1o1l0pp"}">Example</p>
    <p class="${"svelte-1o1l0pp"}">Advanced Customization</p>
