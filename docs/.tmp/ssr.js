...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <section id="${"slots"}" class="${"svelte-18on4kq"}"><div class="${"info svelte-18on4kq"}"><h2 class="${"svelte-18on4kq"}"><a href="${"#slots"}" class="${"svelte-18on4kq"}">Slots</a></h2>
    ...
    ${validate_component(Crossword, "Crossword").$$render($$result, { data: dataNYTDaily }, {}, {
			toolbar: ({ onClear, onReveal }) => `<div class="${"toolbar"}" slot="${"toolbar"}" style="${"background: tan; padding: 1em; margin: 1em 0;"}"><button style="${"font-size: 1.5em; background-color: red;"}" class="${"svelte-18on4kq"}">clear puzzle</button>
        <button style="${"font-size: 1.5em; background-color: red;"}" class="${"svelte-18on4kq"}">show answers</button></div>`,
