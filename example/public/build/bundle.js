...
var app = (function () {
    ...
    function create_each_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(192:4) {#each cells as { x, y, value, index, number, custom }}",
    		ctx
    	});
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$3, 214, 2, 6302);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(214:0) {#if keyboardVisible}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(svg, "viewBox", svg_viewBox_value = "0 0 " + /*w*/ ctx[9] + " " + /*h*/ ctx[10]);
    			attr_dev(svg, "class", "svelte-ce6hth");
    			add_location(svg, file$3, 190, 2, 5633);
    			...
    			add_location(section, file$3, 185, 0, 5533);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(window, "click", /*onClick*/ ctx[19], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("secondarilyFocusedCells" in $$props) $$invalidate(8, secondarilyFocusedCells = $$props.secondarilyFocusedCells);
    		if ("isMobile" in $$props) $$invalidate(29, isMobile = $$props.isMobile);
    ...
    class Puzzle extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*clues*/ ctx[21] === undefined && !("clues" in props)) {
    		...
    		if (/*focusedDirection*/ ctx[20] === undefined && !("focusedDirection" in props)) {
    		...
    		if (/*focusedCell*/ ctx[22] === undefined && !("focusedCell" in props)) {
    		...
    		if (/*showKeyboard*/ ctx[23] === undefined && !("showKeyboard" in props)) {
    ...
    // (93:6) <div         class="toolbar"         slot="toolbar"         let:onClear         let:onReveal         style="background: tan; padding: 1em; margin: 1em 0;">
    function create_toolbar_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			attr_dev(button0, "class", "svelte-1uvk5z8");
    			add_location(button0, file$b, 98, 8, 2846);
    			set_style(button1, "font-size", "1.5em");
    			set_style(button1, "background-color", "red");
    			attr_dev(button1, "class", "svelte-1uvk5z8");
    			add_location(button1, file$b, 101, 8, 2974);
    			...
    			add_location(div, file$b, 92, 6, 2682);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, button0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(93:6) <div         class=\\\"toolbar\\\"         slot=\\\"toolbar\\\"         let:onClear         let:onReveal         style=\\\"background: tan; padding: 1em; margin: 1em 0;\\\">",
    		ctx
    	});
    ...
    function create_message_slot(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(h3, file$b, 106, 8, 3143);
    			...
    			add_location(img, file$b, 107, 8, 3175);
    			attr_dev(div, "slot", "message");
    			add_location(div, file$b, 105, 6, 3114);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h3);
    ...
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(92:4) <Crossword data=\\\"{dataNYTDaily}\\\">",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			attr_dev(h1, "class", "svelte-1uvk5z8");
    			...
    			add_location(a2, file$b, 21, 6, 637);
    			attr_dev(a3, "href", "https://twitter.com/codenberg");
    			add_location(a3, file$b, 23, 6, 720);
    			attr_dev(p0, "class", "svelte-1uvk5z8");
    			add_location(p0, file$b, 15, 4, 403);
    			attr_dev(div0, "class", "intro svelte-1uvk5z8");
    			add_location(div0, file$b, 13, 2, 349);
    			attr_dev(h20, "class", "svelte-1uvk5z8");
    			add_location(h20, file$b, 29, 6, 857);
    			attr_dev(a4, "href", "https://www.nytimes.com/crosswords/game/daily/2020/10/21");
    			add_location(a4, file$b, 32, 8, 902);
    			attr_dev(p1, "class", "svelte-1uvk5z8");
    			add_location(p1, file$b, 30, 6, 880);
    			attr_dev(div1, "class", "info svelte-1uvk5z8");
    			add_location(div1, file$b, 28, 4, 832);
    			attr_dev(section0, "id", "default");
    			attr_dev(section0, "class", "svelte-1uvk5z8");
    			add_location(section0, file$b, 27, 2, 805);
    			attr_dev(h21, "class", "svelte-1uvk5z8");
    			add_location(h21, file$b, 42, 6, 1188);
    			attr_dev(a5, "href", "https://www.nytimes.com/crosswords/game/mini/2020/10/21");
    			add_location(a5, file$b, 45, 8, 1232);
    			attr_dev(p2, "class", "svelte-1uvk5z8");
    			add_location(p2, file$b, 43, 6, 1210);
    			attr_dev(div2, "class", "info svelte-1uvk5z8");
    			add_location(div2, file$b, 41, 4, 1163);
    			attr_dev(section1, "id", "mini");
    			set_style(section1, "max-width", "500px");
    			attr_dev(section1, "class", "svelte-1uvk5z8");
    			add_location(section1, file$b, 40, 2, 1113);
    			attr_dev(h22, "class", "svelte-1uvk5z8");
    			add_location(h22, file$b, 55, 6, 1578);
    			attr_dev(p3, "class", "svelte-1uvk5z8");
    			add_location(p3, file$b, 56, 6, 1600);
    			option0.__value = "classic";
    			option0.value = option0.__value;
    			add_location(option0, file$b, 58, 8, 1700);
    			option1.__value = "dark";
    			option1.value = option1.__value;
    			add_location(option1, file$b, 59, 8, 1749);
    			option2.__value = "citrus";
    			option2.value = option2.__value;
    			add_location(option2, file$b, 61, 8, 1848);
    			if (/*theme*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[2].call(select));
    			add_location(select, file$b, 57, 6, 1662);
    			attr_dev(div3, "class", "info svelte-1uvk5z8");
    			add_location(div3, file$b, 54, 4, 1553);
    			add_location(div4, file$b, 64, 4, 1918);
    			attr_dev(section2, "id", "themes");
    			attr_dev(section2, "class", section2_class_value = "" + (null_to_empty(/*theme*/ ctx[1]) + " svelte-1uvk5z8"));
    			set_style(section2, "max-width", "760px");
    			add_location(section2, file$b, 53, 2, 1485);
    			attr_dev(h23, "class", "svelte-1uvk5z8");
    			add_location(h23, file$b, 71, 6, 2104);
    			attr_dev(code0, "class", "svelte-1uvk5z8");
    			add_location(code0, file$b, 74, 8, 2221);
    			attr_dev(code1, "class", "svelte-1uvk5z8");
    			add_location(code1, file$b, 76, 8, 2293);
    			attr_dev(p4, "class", "svelte-1uvk5z8");
    			add_location(p4, file$b, 72, 6, 2140);
    			attr_dev(div5, "class", "info svelte-1uvk5z8");
    			add_location(div5, file$b, 70, 4, 2079);
    			attr_dev(section3, "id", "simple-customization");
    			attr_dev(section3, "class", "svelte-1uvk5z8");
    			toggle_class(section3, "is-revealed", /*revealedUSA*/ ctx[0]);
    			add_location(section3, file$b, 69, 2, 2005);
    			attr_dev(h24, "class", "svelte-1uvk5z8");
    			add_location(h24, file$b, 88, 6, 2546);
    			attr_dev(p5, "class", "svelte-1uvk5z8");
    			add_location(p5, file$b, 89, 6, 2567);
    			attr_dev(div6, "class", "info svelte-1uvk5z8");
    			add_location(div6, file$b, 87, 4, 2521);
    			attr_dev(section4, "id", "slots");
    			attr_dev(section4, "class", "svelte-1uvk5z8");
    			add_location(section4, file$b, 86, 2, 2496);
    			attr_dev(article, "class", "svelte-1uvk5z8");
