...
<g class="${[
		"cell " + escape(custom) + " svelte-wk9yyo",
		(isFocused ? "is-focused" : "") + " " + (isSecondarilyFocused ? "is-secondarily-focused" : "")
	].join(" ").trim()}"${add_attribute("transform", `translate(${x}, ${y})`, 0)} id="${"cell-" + escape(x) + "-" + escape(y)}" tabIndex="${"0"}"${add_attribute("this", element, 1)}><rect width="${"1"}" height="${"1"}" class="${"svelte-wk9yyo"}"></rect>${value
...
const Puzzle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["puzzle svelte-1olsp4l", stacked ? "stacked" : ""].join(" ").trim()}"><svg viewBox="${"0 0 " + escape(w) + " " + escape(h)}" class="${"svelte-1olsp4l"}">${each(cells, ({ x, y, value, index, number, custom }) => `${validate_component(Cell, "Cell").$$render(
		$$result,
		{
			x,
			y,
...
&#39;${keyboardVisible
	? `
  <div class="${"keyboard svelte-1olsp4l"}">${validate_component(Keyboard, "Keyboard").$$render($$result, {}, {}, {})}</div>`
	: ``}`;
});
...
const css$4 = {
	code: "button.svelte-15h9c89{display:block;width:100%;background:none;text-align:left;appearance:none;outline:none;border:none;border-left:6px solid transparent;padding:0.5em;cursor:pointer;line-height:1.325;color:var(--clue-text-color);font-family:var(--clue-text-font);font-size:1em;cursor:pointer}.clue.svelte-15h9c89:focus{border-color:var(--secondary-color)}.is-number-focused.svelte-15h9c89{border-left-color:var(--secondary-color)}.is-number-focused.is-direction-focused.svelte-15h9c89{background:var(--secondary-color)}.is-filled.svelte-15h9c89{opacity:0.33}",
	map: "{\"version\":3,\"file\":\"Clue.svelte\",\"sources\":[\"Clue.svelte\"],\"sourcesContent\":[\"<script>\\n  import scrollTo from \\\"./helpers/scrollTo.js\\\";\\n\\n  export let number;\\n  export let clue;\\n  export let custom;\\n  export let isFilled;\\n  export let isNumberFocused = false;\\n  export let isDirectionFocused = false;\\n  export let onFocus = () => {};\\n\\n  let element;\\n\\n  $: isFocused = isNumberFocused;\\n</script>\\n\\n<li bind:this=\\\"{element}\\\" use:scrollTo=\\\"{isFocused}\\\">\\n  <button\\n    class=\\\"clue {custom}\\\"\\n    class:is-number-focused=\\\"{isNumberFocused}\\\"\\n    class:is-direction-focused=\\\"{isDirectionFocused}\\\"\\n    class:is-filled=\\\"{isFilled}\\\"\\n    on:click=\\\"{onFocus}\\\">\\n    {number}.\\n    {clue}\\n  </button>\\n</li>\\n\\n<style>\\n  button {\\n    display: block;\\n    width: 100%;\\n    background: none;\\n    text-align: left;\\n    appearance: none;\\n    outline: none;\\n    border: none;\\n    border-left: 6px solid transparent;\\n    padding: 0.5em;\\n    cursor: pointer;\\n    line-height: 1.325;\\n    color: var(--clue-text-color);\\n    font-family: var(--clue-text-font);\\n    font-size: 1em;\\n    cursor: pointer;\\n  }\\n  .clue:focus {\\n    border-color: var(--secondary-color);\\n  }\\n  .is-number-focused {\\n    border-left-color: var(--secondary-color);\\n  }\\n  .is-number-focused.is-direction-focused {\\n    background: var(--secondary-color);\\n  }\\n  .is-filled {\\n    opacity: 0.33;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA6BE,MAAM,eAAC,CAAC,AACN,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,WAAW,CAClC,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,OAAO,CACf,WAAW,CAAE,KAAK,CAClB,KAAK,CAAE,IAAI,iBAAiB,CAAC,CAC7B,WAAW,CAAE,IAAI,gBAAgB,CAAC,CAClC,SAAS,CAAE,GAAG,CACd,MAAM,CAAE,OAAO,AACjB,CAAC,AACD,oBAAK,MAAM,AAAC,CAAC,AACX,YAAY,CAAE,IAAI,iBAAiB,CAAC,AACtC,CAAC,AACD,kBAAkB,eAAC,CAAC,AAClB,iBAAiB,CAAE,IAAI,iBAAiB,CAAC,AAC3C,CAAC,AACD,kBAAkB,qBAAqB,eAAC,CAAC,AACvC,UAAU,CAAE,IAAI,iBAAiB,CAAC,AACpC,CAAC,AACD,UAAU,eAAC,CAAC,AACV,OAAO,CAAE,IAAI,AACf,CAAC\"}"
};
...
const Clue = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<li${add_attribute("this", element, 1)}><button class="${[
		"clue " + escape(custom) + " svelte-15h9c89",
...
const Clues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["clues svelte-1iflft1", stacked ? "stacked" : ""].join(" ").trim()}">${stacked
	? `<div class="${"clues--stacked svelte-1iflft1"}">${validate_component(ClueBar, "ClueBar").$$render($$result, { currentClue }, {}, {})}</div>`
...
const css$a = {
	code: "article.svelte-1ic29sn{position:relative;background-color:var(--bg);font-size:16px}.play.svelte-1ic29sn{display:flex;flex-direction:var(--order, row)}.play.stacked.svelte-1ic29sn{flex-direction:column}",
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword svelte-1ic29sn"}"${add_attribute("style", inlineStyles, 0)}>${slots.toolbar
			? slots.toolbar({ onClear, onReveal })
			: `
      ${validate_component(Toolbar, "Toolbar").$$render($$result, { actions }, {}, {})}
    `}

    <div class="${["play svelte-1ic29sn", stacked ? "stacked" : ""].join(" ").trim()}">${validate_component(Clues, "Clues").$$render(
				$$result,
				{
					clues,
					cellIndexMap,
