...
const Puzzle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["puzzle svelte-1q7m2j2", stacked ? "stacked" : ""].join(" ").trim()}"><svg viewBox="${"0 0 " + escape(w) + " " + escape(h)}" class="${"svelte-1q7m2j2"}">${each(cells, ({ x, y, value, index, number, custom }) => `${validate_component(Cell, "Cell").$$render(
		$$result,
		{
			x,
			y,
...
<div class="${"keyboard svelte-1q7m2j2"}">${validate_component(Keyboard, "Keyboard").$$render($$result, {}, {}, {})}
</div>`;
});
...
const css$4 = {
	code: "button.svelte-1i661i1{display:block;width:100%;background:none;text-align:left;appearance:none;outline:none;border:none;border-left:6px solid transparent;padding:0.5em;cursor:pointer;line-height:1.325;color:var(--clue-text-color, #1a1a1a);font-family:var(--clue-font, -apple-system, Helvetica, sans-serif);font-size:1em;cursor:pointer}.clue.svelte-1i661i1:focus{border-color:var(--cell-highlight-color, #ffec99)}.is-number-focused.svelte-1i661i1{border-left-color:var(--cell-highlight-color, #ffec99)}.is-number-focused.is-direction-focused.svelte-1i661i1{background:var(--cell-highlight-color, #ffec99)}.is-filled.svelte-1i661i1{opacity:0.33}",
...
const Clues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["clues svelte-8zo0qz", stacked ? "stacked" : ""].join(" ").trim()}">${stacked
	? `<div class="${"clues--stacked svelte-8zo0qz"}">${validate_component(ClueBar, "ClueBar").$$render($$result, { currentClue }, {}, {})}</div>`
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword " + escape(themeClass) + " svelte-1ein5he"}">${slots.toolbar
			? slots.toolbar({ onClear, onReveal })
			: `
      ${validate_component(Toolbar, "Toolbar").$$render($$result, { actions }, {}, {})}
    `}

    <div class="${["play svelte-1ein5he", stacked ? "stacked" : ""].join(" ").trim()}">${validate_component(Clues, "Clues").$$render(
				$$result,
				{
					clues,
					cellIndexMap,
