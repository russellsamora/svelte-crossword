...
const Toolbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"toolbar svelte-1d4ytnk"}">${each(actions, action => `${action == "clear"
	? `<button class="${"svelte-1d4ytnk"}">Clear</button>`
	: `${action == "reveal"
		? `<button class="${"svelte-1d4ytnk"}">Reveal</button>`
		: ``}`}`)}
</div>`;
});
...
const Puzzle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["puzzle svelte-8s1bxc", desktop ? "desktop" : ""].join(" ").trim()}"><svg viewBox="${"0 0 " + escape(w) + " " + escape(h)}" class="${"svelte-8s1bxc"}">${each(cells, ({ x, y, value, index, number, custom }) => `${validate_component(Cell, "Cell").$$render(
		$$result,
		{
			x,
			y,
...
<div class="${["keyboard svelte-8s1bxc", desktop ? "desktop" : ""].join(" ").trim()}">${validate_component(Keyboard, "Keyboard").$$render($$result, {}, {}, {})}
</div>`;
});
...
const css$5 = {
	code: ".list.svelte-1k6v3oi{position:relative;max-height:45vh;margin-bottom:2em;overflow:auto}p.svelte-1k6v3oi{font-family:var(--clue-font, -apple-system, Helvetica, sans-serif);color:var(--clue-text-color, #1a1a1a);font-weight:700;text-transform:uppercase;padding-left:calc(0.5em + 6px);padding-bottom:0.5em;margin:0}ul.svelte-1k6v3oi{list-style-type:none;padding-left:0;margin:0;margin-top:1em}.svelte-1k6v3oi::-moz-scrollbar{width:9px}.svelte-1k6v3oi::-webkit-scrollbar{width:9px}.svelte-1k6v3oi::-moz-scrollbar-track{box-shadow:none;border-radius:10px;background:var(--clue-scrollbar-bg, #efefef)}.svelte-1k6v3oi::-webkit-scrollbar-track{box-shadow:none;border-radius:10px;background:var(--clue-scrollbar-bg, #efefef)}.svelte-1k6v3oi::scrollbar-thumb{border-radius:10px;background:var(--clue-scrollbar-fg, #cdcdcd);box-shadow:none}.svelte-1k6v3oi::-moz-scrollbar-thumb{background:var(--clue-scrollbar-fg, #cdcdcd);border-radius:6px}.svelte-1k6v3oi::-webkit-scrollbar-thumb{background:var(--clue-scrollbar-fg, #cdcdcd);border-radius:6px}",
	map: "{\"version\":3,\"file\":\"ClueList.svelte\",\"sources\":[\"ClueList.svelte\"],\"sourcesContent\":[\"<script>\\n  import Clue from \\\"./Clue.svelte\\\";\\n\\n  export let direction;\\n  export let clues;\\n  export let focusedClueNumbers;\\n  export let isDirectionFocused;\\n  export let onClueFocus;\\n</script>\\n\\n<p>{direction}</p>\\n<div class=\\\"list\\\">\\n  <ul>\\n    {#each clues as clue}\\n      <Clue\\n        clue=\\\"{clue.clue}\\\"\\n        number=\\\"{clue.number}\\\"\\n        isFilled=\\\"{clue.isFilled}\\\"\\n        isNumberFocused=\\\"{focusedClueNumbers[direction] === clue.number}\\\"\\n        isDirectionFocused=\\\"{isDirectionFocused}\\\"\\n        onFocus=\\\"{() => onClueFocus(clue)}\\\" />\\n    {/each}\\n  </ul>\\n</div>\\n\\n<style>\\n  .list {\\n    position: relative;\\n    max-height: 45vh;\\n    margin-bottom: 2em;\\n    overflow: auto;\\n  }\\n\\n  p {\\n    font-family: var(--clue-font, -apple-system, Helvetica, sans-serif);\\n    color: var(--clue-text-color, #1a1a1a);\\n    font-weight: 700;\\n    text-transform: uppercase;\\n    padding-left: calc(0.5em + 6px);\\n    padding-bottom: 0.5em;\\n    margin: 0;\\n  }\\n\\n  ul {\\n    list-style-type: none;\\n    padding-left: 0;\\n    margin: 0;\\n    margin-top: 1em;\\n  }\\n\\n  ::-moz-scrollbar {\\n    width: 9px;\\n  }\\n  ::-webkit-scrollbar {\\n    width: 9px;\\n  }\\n\\n  ::-moz-scrollbar-track {\\n    box-shadow: none;\\n    border-radius: 10px;\\n    background: var(--clue-scrollbar-bg, #efefef);\\n  }\\n  ::-webkit-scrollbar-track {\\n    box-shadow: none;\\n    border-radius: 10px;\\n    background: var(--clue-scrollbar-bg, #efefef);\\n  }\\n  ::scrollbar-thumb {\\n    border-radius: 10px;\\n    background: var(--clue-scrollbar-fg, #cdcdcd);\\n    box-shadow: none;\\n  }\\n  ::-moz-scrollbar-thumb {\\n    background: var(--clue-scrollbar-fg, #cdcdcd);\\n    border-radius: 6px;\\n  }\\n  ::-webkit-scrollbar-thumb {\\n    background: var(--clue-scrollbar-fg, #cdcdcd);\\n    border-radius: 6px;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA0BE,KAAK,eAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,IAAI,AAChB,CAAC,AAED,CAAC,eAAC,CAAC,AACD,WAAW,CAAE,IAAI,WAAW,CAAC,qCAAqC,CAAC,CACnE,KAAK,CAAE,IAAI,iBAAiB,CAAC,QAAQ,CAAC,CACtC,WAAW,CAAE,GAAG,CAChB,cAAc,CAAE,SAAS,CACzB,YAAY,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/B,cAAc,CAAE,KAAK,CACrB,MAAM,CAAE,CAAC,AACX,CAAC,AAED,EAAE,eAAC,CAAC,AACF,eAAe,CAAE,IAAI,CACrB,YAAY,CAAE,CAAC,CACf,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,GAAG,AACjB,CAAC,eAED,gBAAgB,AAAC,CAAC,AAChB,KAAK,CAAE,GAAG,AACZ,CAAC,eACD,mBAAmB,AAAC,CAAC,AACnB,KAAK,CAAE,GAAG,AACZ,CAAC,eAED,sBAAsB,AAAC,CAAC,AACtB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,IAAI,mBAAmB,CAAC,QAAQ,CAAC,AAC/C,CAAC,eACD,yBAAyB,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,IAAI,mBAAmB,CAAC,QAAQ,CAAC,AAC/C,CAAC,eACD,iBAAiB,AAAC,CAAC,AACjB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,IAAI,mBAAmB,CAAC,QAAQ,CAAC,CAC7C,UAAU,CAAE,IAAI,AAClB,CAAC,eACD,sBAAsB,AAAC,CAAC,AACtB,UAAU,CAAE,IAAI,mBAAmB,CAAC,QAAQ,CAAC,CAC7C,aAAa,CAAE,GAAG,AACpB,CAAC,eACD,yBAAyB,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,mBAAmB,CAAC,QAAQ,CAAC,CAC7C,aAAa,CAAE,GAAG,AACpB,CAAC\"}"
};
...
const ClueList = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<p class="${"svelte-1k6v3oi"}">${escape(direction)}</p>
<div class="${"list svelte-1k6v3oi"}"><ul class="${"svelte-1k6v3oi"}">${each(clues, clue => `${validate_component(Clue, "Clue").$$render(
		$$result,
		{
			clue: clue.clue,
			number: clue.number,
...
const ClueBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"bar svelte-1k30qnz"}"><button class="${"svelte-1k30qnz"}"><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" class="${"feather feather-chevron-left"}"><polyline points="${"15 18 9 12 15 6"}"></polyline></svg></button>
  <p class="${"svelte-1k30qnz"}">${escape(clue)}</p>
  <button class="${"svelte-1k30qnz"}"><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" stroke="${"currentColor"}" stroke-width="${"2"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}" class="${"feather feather-chevron-right"}"><polyline points="${"9 18 15 12 9 6"}"></polyline></svg></button>
</div>`;
});
...
const Clues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section class="${["clues svelte-1qb7ypz", desktop ? "desktop" : ""].join(" ").trim()}"><div class="${["clues--desktop svelte-1qb7ypz", desktop ? "desktop" : ""].join(" ").trim()}">${each(["across", "down"], direction => `${validate_component(ClueList, "ClueList").$$render(
		$$result,
		{
			direction,
			focusedClueNumbers,
  ...
  <div class="${["clues--mobile svelte-1qb7ypz", desktop ? "desktop" : ""].join(" ").trim()}">${validate_component(ClueBar, "ClueBar").$$render($$result, { currentClue }, {}, {})}</div>
</section>`;
});
...
const Crossword = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `${validated
		? `<article class="${"crossword " + escape(themeClass) + " svelte-9nwuv5"}">${slots.toolbar
			? slots.toolbar({ onClear, onReveal })
			: `
      ${validate_component(Toolbar, "Toolbar").$$render($$result, { actions }, {}, {})}
    `}

    <div class="${["play svelte-9nwuv5", desktop ? "desktop" : ""].join(" ").trim()}">${validate_component(Clues, "Clues").$$render(
				$$result,
				{
					clues,
					cellIndexMap,
...
const App = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	do {
		...
		$$rendered = `<article class="${"svelte-powwth"}"><div class="${"intro svelte-powwth"}"><h1 class="${"svelte-powwth"}">Svelte Crossword</h1>
  ...
  <section id="${"default"}" class="${"svelte-powwth"}"><div class="${"info svelte-powwth"}"><h2 class="${"svelte-powwth"}">Default</h2>
  ...
  <section id="${"mini"}" style="${"max-width: 480px;"}" class="${"svelte-powwth"}"><div class="${"info svelte-powwth"}"><h2 class="${"svelte-powwth"}">Mobile</h2>
      <p class="${"svelte-powwth"}">A
        <a href="${"https://www.nytimes.com/crosswords/game/mini/2020/10/21"}">NYT
          mini</a>
        puzzle with all default settings and forced mobile view.
  ...
  <section id="${"themes"}" class="${"svelte-powwth"}"><div class="${"info svelte-powwth"}"><h2 class="${"svelte-powwth"}">Themes</h2>
      <p class="${"svelte-powwth"}">A library of preset style themes to choose from.</p>
      <select${add_attribute("value", theme, 1)}><option value="${"classic"}">Classic</option><option value="${"dark"}">Dark</option><option value="${"amelia"}">Amelia</option><option value="${"citrus"}">Citrus</option></select></div>
  ...
  <section id="${"simple-customization"}" class="${["svelte-powwth", revealedUSA ? "is-revealed" : ""].join(" ").trim()}"><div class="${"info svelte-powwth"}"><h2 class="${"svelte-powwth"}">Simple Customization</h2>
      <p class="${"svelte-powwth"}">Custom class name on cells.</p></div>
  ...
  <section id="${"advanced-customization"}" class="${"svelte-powwth"}"><div class="${"info svelte-powwth"}"><h2 class="${"svelte-powwth"}">Advanced Customization</h2>
      <p class="${"svelte-powwth"}">TBD.</p></div>
